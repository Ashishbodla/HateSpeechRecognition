...
train = pd.read_csv(r'/Users/nageswar/Desktop/Hate Speech/HateSpeech-3/tfidf_vectored_train.csv')

test = pd.read_csv(r'/Users/nageswar/Desktop/Hate Speech/HateSpeech-3/tfidf_vectored_test.csv')
...
for i in range(3,20):
    ...
    pickle.dump(neigh,open(r'.\tfidf_vectors_models\Neigh_{}.sav'.format(i),'wb'))
...
pickle.dump(clf,open(r'.\tfidf_vectors_models\SVM_SVC.sav','wb'))
...
pickle.dump(MNB, open(r'.\tfidf_vectors_models\MNB_counts.sav','wb'))
...
for N in range(100,1000,100):
    ...
    pickle.dump(rfc, open(r'.\tfidf_vectors_models\RFC_{}.sav'.format(N),'wb'))
